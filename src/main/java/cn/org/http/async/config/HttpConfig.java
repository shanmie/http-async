package cn.org.http.async.config;
...
//		map.put(Utils.ENTITY_MULTIPART+".rmCharset", forceRemoveContentTypeChraset);
        ...
        m.put(EntityCons.ENTITY_MULTIPART, filePaths);
        m.put(EntityCons.ENTITY_MULTIPART+".name", inputName);
        m.put(EntityCons.ENTITY_MULTIPART+".rmCharset", forceRemoveContentTypeChraset);
        maps.set(m);
        return this;
    }
